...
const TopCountriesCard = () => {
    return (
        <div
            className="relative w-[320px] p-4 shadow-sm shadow-indigo-100 block rounded-xl bg-[url(https://images.pexels.com/photos/2779863/pexels-photo-2779863.jpeg?cs=srgb&dl=pexels-nextvoyage-2779863.jpg&fm=jpg)] bg-cover bg-center bg-no-repeat"
        >
