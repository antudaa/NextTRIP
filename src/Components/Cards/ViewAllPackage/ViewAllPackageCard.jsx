...
const ViewAllPackageCard = ({ allPack }) => {
    ...
    return (
        <div className={`${category[0]}`} style={{ "backgroundColor": "rgba(0, 0, 0, 0)" }}>

            <div className="container px-5 mx-auto" style={{ "cursor": "auto" }}>
                <h3 className='text-center text-3xl my-8 uppercase font-bold text-sky-500'></h3>
                        ...
                        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                            ...
                            <div className="flex ml-6 items-center">
                                ...
                                <div className="relative">
                                    <select className="rounded cursor-pointer border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base pl-3 pr-10">
