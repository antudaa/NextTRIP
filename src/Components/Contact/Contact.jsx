...
const Contact = () => {
    ...
    const contactMethods = [
        ...
        },
        {
            ...
            ,
            contact: "Dhanmondi, Dhaka, Bangladesh."
        },
    ]

    return (
        <main className="py-14 bg-slate-400">
            <div className="w-[90vw] mx-auto px-4 bg-[#e1e6ec] text-gray-600 md:px-8 rounded-md">
                <div className="max-w-xxlg mx-auto gap-12 p-8 justify-between lg:flex lg:max-w-none">
                    ...
                    <div className="flex-1 mt-12 mx-auto md:mx-0 sm:max-w-lg lg:max-w-md">
                        ...
                        >
                            ...
                            <button type="submit"
                                className="bg-indigo-500 hover:bg-indigo-700 text-white text-xl py-2 px-4 md:px-6 rounded transition-colors duration-300 w-full mx-auto">Submit<span className="ml-2"></span>
