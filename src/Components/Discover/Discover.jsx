    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 w-full py-10">
            ...
            <div className="relative group opacity-100 flex justify-center items-center h-full w-full overflow-hidden bg-cover bg-no-repeat">
                ...
                <img className="object-center object-cover h-[280px] w-full overflow-hidden transition duration-600 ease-in-out hover:scale-110" src="https://assets3.thrillist.com/v1/image/3109501/1200x630/flatten;crop_down;webp=auto;jpeg_quality=70" alt="shoe-image" />
            ...
            <div className="relative group opacity-90 flex justify-center items-center h-full w-full overflow-hidden bg-cover bg-no-repeat">
                ...
                <img className="object-center  object-cover h-[280px] w-full transition duration-600 ease-in-out hover:scale-110" src="https://images4.alphacoders.com/103/1032233.jpg" alt="shoe-image" />
                <div className="dark:text-white text-center z-10 absolute leading-none text-gray-800 py-3 w-72">
