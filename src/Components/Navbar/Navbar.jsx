        ...
        <nav className={`bg-[aliceblue] opacity-100  w-full border-none`}>
            <div className="flex items-center justify-between py-3 px-4 max-w-screen-xxl mx-auto md:px-8">
                ...
                <div className="flex-1 flex items-center right-0 justify-between">
                    <div className={`lg:bg-transparent bg-white absolute z-30 w-full top-0 left-0 p-4 border-b lg:static lg:block lg:border-none ${menuState ? '' : 'hidden'}`}>
                        ...
                        <ProfileDropDown
                            class="mt-5 pt-5 border-t lg:hidden cursor-pointer z-20"
                        />
                    </div>
                    <div className="flex-1 flex items-center justify-end space-x-2 sm:space-x-6">
                        ...
                        <ProfileDropDown
                            class="hidden lg:block cursor-pointer z-20"
                        />
                        <button
                            className="outline-none z-30 text-gray-400 block lg:hidden"
